        ...
        <div className='container heroSlider mb-8'>
            <Slider ref={sliderRef} {...heroSliderSettings} className='-ml-2'>
                {HERO?.map(({ id, image, brand }) => (
                    <div key={id} className='relative max-h-[600px]'>
                        {/* Image */}
                        <Avatar
                            src={image}
            ...
            <div
                className='flex items-center justify-center w-10 h-10 bg-black/40 backdrop-blur-md rounded-full cursor-pointer absolute left-2 top-[48%] xs:top-[50%] sm:top-[60%] md:top-[70%]'
                onClick={prevSlide}
            >
                <Icons.ChevronRight className='rotate-180 text-white' />
            </div>
            <div
                className='flex items-center justify-center w-10 h-10 bg-black/40 backdrop-blur-md rounded-full cursor-pointer absolute right-2 top-[48%] xs:top-[50%] sm:top-[60%] md:top-[70%]'
                onClick={nextSlide}
            >
