...
interface RecentViewSingleCardProps extends ProductCardProps {
    isEditMode: boolean;
}

const RecentViewSingleCard = ({
    image,
    brand,
    name,
    regularPrice,
    ...
    return (
        <div className='group relative col-span-4'>
            ...
            >
                ...
                />
                {/* Overlay & Remove Button in Edit Mode */}
                {isEditMode && (
...
export default RecentViewSingleCard;
