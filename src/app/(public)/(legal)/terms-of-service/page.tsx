        ...
        <div className='max-w-4xl mx-auto px-4 py-8'>
            ...
            <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 mb-4'>
                    <li className='mb-2'>
                        ...
                        to return or exchange only according to our Refund
                        Policy.
                    </li>
                    <li className='mb-2'>
                    ...
                    <li className='mb-2'>
                        ...
                        anytime without notice, at the sole discretion of us.
                    </li>
                    <li className='mb-2'>
            ...
            <section className='mb-8'>
                ...
                <p className='mb-4'>
                    ...
                    perform or participate in any unlawful acts, to violate any
                    international, federal, provincial or state regulations,
                    rules, laws, or local ordinances, or to infringe upon or
            ...
            <section className='mb-8'>
                ...
                <p className='mb-4'>
                    You agree to indemnify, defend and hold harmless Brands
                    Discounts and our parent, subsidiaries, affiliates,
            ...
            <section className='mb-8'>
                ...
                <p className='mb-4'>
                    Brands Discounts is an independent retailer of various
                    products. Any reference to trademarks or brand names is for
                    identification purposes only and does not imply any
                    affiliation, endorsement, or sponsorship by the trademark
                    owner.
                </p>
            </section>
        </div>
